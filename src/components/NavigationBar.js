...
const NavigationBar = (props) => {
    ...
    }, [props.key, props.title, props.idKey])
                ...
                <nav className="navbar navbar-dark bg-dark" >
                    <div className="container-fluid">
                        <div type="button" className="navbar-brand" onClick={to_up}>
                            <img id='logo' alt='logo' src={logo} width="10px" height="10px"></img> Reformas Integrales Vicent
                        </div>
                    ...
                    <div className="container-fluid">
                        ...
                        <form className="d-flex">
                            ...
                            <Link className="btn btn-outline-success" onClick={catIdProduct} id='buscar'>Buscar</Link>
                        </form>
                    </div>
                </nav>
            </header>
